...
open class RemoteUpdateManage: NSObject {
    ...
    public  func queryState(state:Int,vin:String,uDate:String,taskcarId:String,success:@escaping (WebStateModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
    ...
    /// - Parameter uDate: 操作时间
    /// - Parameter taskcarId: 车辆任务id
    public  func getCarUpdateTask(vin:String,uDate:String,taskcarId:String,success:@escaping (CurrentVehicleTaskResModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
                NetWorkRequest(.queryCarUpdateTask(vin: vin, uDate: uDate, taskcarId: taskcarId), completion: {(jsonString)->(Void)in
    ...
    /// - Parameter vin: 车辆VIN
    /// - Parameter uDate: 操作时间
    public  func getVersionInformation(vin:String,uDate:String,success:@escaping (VerIformationModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
    ...
    public func queryUpdateProgress(vin:String,taskCarId:String,uDate:String,success:@escaping (UpdateProgressModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
    ...
    /// - Parameter taskcarId: 车辆任务id
    /// - Parameter uDate: 操作时间
    public  func queryUpdateResult(vin:String,taskcarId:String,uDate:String,success:@escaping (UpdateResultModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
                NetWorkRequest(.queryCarUpdateTask(vin: vin, uDate: uDate, taskcarId: taskcarId), completion: {(jsonString)->(Void)in
    ...
    /// - Parameter pi: 页面索引
    /// - Parameter ps: 页面大小
    public  func getHistoryUpdate(vin:String,uDate:String,pi:Int,ps:Int,success:@escaping (HistoryUpdateModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
    ...
    public func confirmUpgrade(taskcarId:String,uDate:String,type:Int,result:Int,success:@escaping (ConfirmUpdateModel) -> (Void),failed:@escaping (String) -> (Void)) -> Void {
